...
import TestModalComponent from './ModalContent/TestModalContent'; //예시 1.모달의 마크업 컴포넌트를 import해서 content에 전달해줍니다.
/**
...
const CustomModal = (isModalOpen, setIsModalOpen, handleModalToggle) => {
  return (
    <Portal>
      <ModalBox
        content={<TestModalComponent />} //2. 모달안에 들어갈 마크업된 컴포넌트 자체를 props로 전달합니다.
